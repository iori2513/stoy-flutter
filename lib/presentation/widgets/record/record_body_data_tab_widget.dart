...
class RecordBodyDataTabWidget extends StatelessWidget {
  const RecordBodyDataTabWidget({
    super.key,
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text('${bodyDataList[0].fatPercentage}'),
                            SizedBox(
                              width: 10.w,
                            ),
                            const Text('%')
                        ...
                        OutlinedWideButton(
                          ...
                          onPressed: () {
                            notifier.goToEditBodyDataPage(
                                context: context, bodyData: bodyDataList[0]);
                          },
                        ),
                        SizedBox(
                          height: 20.h,
